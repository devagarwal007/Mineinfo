    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            621742107, 805484468
                    ...
                    SendMessageIfTheMineHashRateGoBelow46(telegramAddresses);
        ...
        static async void SendMessageIfTheMineHashRateGoBelow46(List<int> ids)
        {
            string message = string.Empty;
                ...
                while (true)
                {
                    ...
                    if (hashRate < 46)
                    {
                        foreach (int id in ids)
                        {
                            await botClient.SendTextMessageAsync(
                              chatId: id,
                              text: $"Warning: Mining rate is below 46. Current mining rate is {hashRate} and Current temp is {message}"
                            );
                        }
                    }
